...
local function writeParamsFile()
	...
	-- defaults
	if params.ALTITUDES == nil then
		params.ALTITUDES = {}
	end
	if params.ALTITUDE_ROUND == nil then
		params.ALTITUDE_ROUND = 50
	end
	if params.FORCE_ALTITUDE == nil then
		params.FORCE_ALTITUDE = false
	end
	if params.SELECTED_ALTITUDE_INDEX == nil then
		params.SELECTED_ALTITUDE_INDEX = 0
	end
...
local function hook_HandleTerrainTool(
	...
	if startedInteraction then
		...
		if forceAltitude == false then
			...
			RoundedAltitude = func.roundToBase(
				func.getVectorLen({
...
local function updateUI()
	...
	if UI.forceAltitudeCheckBox:IsValid() then
		UI.forceAltitudeCheckBox:SetCheckedState(
			params.FORCE_ALTITUDE == true and ECheckBoxState.Checked or ECheckBoxState.Unchecked
		)
	end

	if UI.reverseCheckBox:IsValid() then
		UI.reverseCheckBox:SetCheckedState(
			params.REVERSE == true and ECheckBoxState.Checked or ECheckBoxState.Unchecked
		)
	end
end
...
local function createUI()
	...
	---@type UUserWidget
	UI.userWidget =
		StaticConstructObject(StaticFindObject("/Script/UMG.UserWidget"), gameInstance, FName(prefix .. "UserWidget"))
	assert(UI.userWidget:IsValid())

	UI.userWidget.WidgetTree =
		StaticConstructObject(StaticFindObject("/Script/UMG.WidgetTree"), UI.userWidget, FName(prefix .. "WidgetTree"))
	...
	---@type UVerticalBox
	local verticalBox =
		StaticConstructObject(StaticFindObject("/Script/UMG.VerticalBox"), rootWidget, FName(prefix .. "VerticalBox"))

	---@type UTextBlock
	local textBlock_title =
		StaticConstructObject(StaticFindObject("/Script/UMG.TextBlock"), rootWidget, FName(prefix .. "TextBlock_title"))
	...
	UI.altitudeTextBox = StaticConstructObject(
		StaticFindObject("/Script/UMG.EditableTextBox"),
		rootWidget,
		FName(prefix .. "EditableTextBox_altitude")
	)
	...
	---@type UEditableTextBox
	UI.roundedAltitude = StaticConstructObject(
		StaticFindObject("/Script/UMG.EditableTextBox"),
		rootWidget,
		FName(prefix .. "EditableTextBox_roundedAltitude")
	)
	...
	local horizontalBox = StaticConstructObject(
		...
		rootWidget,
		FName(prefix .. "HorizontalBox")
	)
	horizontalBox:SetToolTipText(FText(optUI.tangent.txt.forceAltitude_tip))

	---@type UTextBlock
	local textBlock_forceAltitude = StaticConstructObject(
		StaticFindObject("/Script/UMG.TextBlock"),
		rootWidget,
		FName(prefix .. "TextBlock_forceAltitude")
	)
	...
	---@type USpacer
	local spacer1 =
		StaticConstructObject(StaticFindObject("/Script/UMG.Spacer"), rootWidget, FName(prefix .. "Spacer1"))
	spacer1:SetSize(optUI.tangent.spacer_size)

	---@type UCheckBox
	UI.forceAltitudeCheckBox = StaticConstructObject(
		StaticFindObject("/Script/UMG.CheckBox"),
		rootWidget,
		FName(prefix .. "CheckBox_forceAltitude")
	)
	...
	---@type UHorizontalBox
	local horizontalBox_altitudeRound = StaticConstructObject(
		StaticFindObject("/Script/UMG.HorizontalBox"),
		rootWidget,
		FName(prefix .. "HorizontalBox2")
	)
	horizontalBox_altitudeRound:SetToolTipText(FText(optUI.tangent.txt.altitudeRound_tip))

	---@type UTextBlock
	local textBlock_altitudeRound = StaticConstructObject(
		StaticFindObject("/Script/UMG.TextBlock"),
		rootWidget,
		FName(prefix .. "TextBlock_altitudeRound")
	)
	...
	---@type USpacer
	local spacer2 =
		StaticConstructObject(StaticFindObject("/Script/UMG.Spacer"), rootWidget, FName(prefix .. "Spacer2"))
	spacer2:SetSize(optUI.tangent.spacer_size)

	---@type UEditableTextBox
	UI.altitudeRound = StaticConstructObject(
		StaticFindObject("/Script/UMG.EditableTextBox"),
		rootWidget,
		FName(prefix .. "EditableTextBox_altitudeRound")
	)
	...
	--#region reverse
	---@type UHorizontalBox
	local horizontalBox_reverse = StaticConstructObject(
		StaticFindObject("/Script/UMG.HorizontalBox"),
		rootWidget,
		FName(prefix .. "HorizontalBox_reverse")
	)
	horizontalBox_reverse:SetToolTipText(FText(optUI.tangent.txt.reverse_tip))

	---@type UTextBlock
	local textBlock_reverse = StaticConstructObject(
		StaticFindObject("/Script/UMG.TextBlock"),
		rootWidget,
		FName(prefix .. "TextBlock_reverse")
	)
	...
	---@type USpacer
	local spacer3 =
		StaticConstructObject(StaticFindObject("/Script/UMG.Spacer"), rootWidget, FName(prefix .. "Spacer3"))
	spacer3:SetSize(optUI.tangent.spacer_size)

	---@type UCheckBox
	UI.reverseCheckBox =
		StaticConstructObject(StaticFindObject("/Script/UMG.CheckBox"), rootWidget, FName(prefix .. "CheckBox_reverse"))
